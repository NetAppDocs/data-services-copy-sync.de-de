...
summary: 'NetApp Copy and Sync kann Zugriffskontrolllisten (ACLs) zwischen SMB-Freigaben und zwischen einer SMB-Freigabe und einem Objektspeicher kopieren (außer ONTAP S3).  Bei Bedarf haben Sie auch die Möglichkeit, ACLs zwischen SMB-Freigaben manuell mithilfe von Robocopy beizubehalten.' 
---
...
* <<Einrichten von „Kopieren und Synchronisieren“ zum Kopieren von ACLs,Richten Sie „Kopieren und Synchronisieren“ ein, um ACLs automatisch zu kopieren>>
