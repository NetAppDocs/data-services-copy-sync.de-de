...
summary: Wenn Sie eine Synchronisierungsbeziehung erstellen, NetApp Copy and Sync Dateien von der Quelle zum Ziel.  Nach der ersten Kopie synchronisiert der Dienst alle geänderten Daten alle 24 Stunden. 
---
