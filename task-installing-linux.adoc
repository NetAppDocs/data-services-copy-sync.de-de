...
+
SELinux erzwingt eine Richtlinie, die Softwareaktualisierungen des Datenbrokers blockiert und den Datenbroker daran hindern kann, mit Endpunkten Kontakt aufzunehmen, die für den normalen Betrieb erforderlich sind.
