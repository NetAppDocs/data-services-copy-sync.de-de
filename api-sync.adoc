...
summary: Die über die Web-Benutzeroberfläche verfügbaren NetApp Copy and Sync Funktionen sind auch über RESTful-APIs verfügbar. 
---
...
[role="lead"]
Die über die Web-Benutzeroberfläche verfügbaren NetApp Copy and Sync Funktionen sind auch über die RESTful-API verfügbar.



== Erste Schritte

Um mit der Copy and Sync-API zu beginnen, benötigen Sie ein Benutzertoken und Ihre NetApp Console -ID.  Sie müssen das Token und die Konto-ID zum Autorisierungsheader hinzufügen, wenn Sie API-Aufrufe tätigen.

.Schritte
. Besorgen Sie sich ein Benutzertoken von der NetApp Console.
+
[source, http]
----
...
.Wie geht es weiter?
Das Benutzertoken der NetApp Console hat ein Ablaufdatum.  Um das Token zu aktualisieren, müssen Sie die API aus Schritt 1 erneut aufrufen.
