...
+
Wählen Sie *Quellobjekte filtern*, um Einstellungen zu ändern, die definieren, wie Quelldateien und -ordner am Zielspeicherort synchronisiert und verwaltet werden.
